...
class CalcCtrl {
	...
	function validate() {
		...
		if ($this->form->installment_type == "") {
			$this->msgs->addError('Nie podano rodzaju raty.');
		}

		//nie ma sensu walidować dalej gdy brak parametrów
		if (!$this->msgs->isError()) {
			if (!is_numeric($this->form->loan)) $this->msgs->addError('Kwota kredytu nie jest liczbą.');
			if (!is_numeric($this->form->months)) $this->msgs->addError('Okres kredytowania nie jest liczbą.');
	...
	function process() {
		...
		// 	$this->msgs->addError('Tylko administrator może liczyć z kwoty powyżej miliona.');
		// 	return false;
		// }
