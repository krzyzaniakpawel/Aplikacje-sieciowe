...
function control($namespace, $controller, $method, $roles = null){
	...
	# pod Linuxem ścieżka się nie zgadzała, więc zamieniam backslasha na zwykłego slasha, ale tylko dla include'a
	include_once str_replace("\\", "/", getConf()->root_path.DIRECTORY_SEPARATOR.$controller.'.class.php');
	$ctrl = new $controller;
